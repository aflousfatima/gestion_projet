    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/signup","/api/login","/api/refresh","/api/logout","/actuator/health","/actuator/prometheus","/api/invitations/verify","/api/project-members/by-user","/api/update","api/change-password","/api/users/details","/api/users/search").permitAll() // Endpoint public pour login
                        ...
                        .requestMatchers("/api/me","/api/user-id","/api/auth/decode-token" ,"/api/tasks_reponsibles/by-ids").authenticated() // Accessible aux authentifiés
