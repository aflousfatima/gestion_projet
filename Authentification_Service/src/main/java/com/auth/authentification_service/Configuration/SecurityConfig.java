    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/signup","/api/login","/api/refresh","/api/logout","/actuator/health","/api/invitations/verify","/api/project-members/by-user").permitAll() // Endpoint public pour login
