      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-6 text-start">
          ...
          <p className="description">
            ...
            Transform the way you manage projects—fast, simple,
            and effective. <br />
        ...
        <div className="cards-container">
         <div className="card">
            ...
            <div className="description">Optimize your workflow, eliminate bottlenecks, and deliver results faster than ever.</div>
            <a href="#" className="read-more">Read more <i className="fas fa-arrow-right"></i></a>
         </div>
         <div className="card">
            <div className="icon"><i className="fas fa-users"></i></div>
            <div className="title">Collaboration</div>
            <div className="description">Seamless teamwork with real-time updates, ensuring everyone stays on the same page.</div>
            <a href="#" className="read-more">Read more <i className="fas fa-arrow-right"></i></a>
         </div>
         <div className="card">
            <div className="icon"><i className="fas fa-expand"></i></div>
            <div className="title">Flexibility</div>
            <div className="description">A solution that adapts to your needs, whether you're a startup or a growing enterprise.</div>
            <a href="#" className="read-more">Read more <i className="fas fa-arrow-right"></i></a>
         </div>
    </div>
